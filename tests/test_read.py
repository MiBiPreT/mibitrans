...
@pytest.mark.parametrize(
    ...
    [
        ...
        (dict(), MissingValueError),
        (dict(bulk_density=1, partition_coefficient=1), MissingValueError),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (dict(bulk_density=1, partition_coefficient=1, fraction_organic_carbon=1), 2, DomainValueError),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (dict(), MissingValueError),
        (dict(delta_oxygen=1, delta_nitrate=1, ferrous_iron=1, delta_sulfate=1), MissingValueError),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (dict(delta_oxygen=1, delta_nitrate=1, ferrous_iron=1, delta_sulfate=1, methane=1), -1, DomainValueError),
    ],
)
