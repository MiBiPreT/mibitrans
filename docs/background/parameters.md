...
| Effective porosity                 | $\theta_e$             | porosity                  | -        |
...
| Partition coefficient              | $K_\mathrm{oc}$        | partition_coefficient     | m$^3$/kg |
| Fraction organic carbon            | $f_\mathrm{oc}$        | fraction_organic_carbon   | -        |
| First order decay coefficient      | $\mu$                  | decay_rate                | 1/d      |
| Contaminant half-life              | $t_{\frac{1}{2}}$      | half_life                 | d        |
| **_Source parameters_**            |                        |                           |          |
...
| **_Other_**                        |                        |                           |          |
| Source depletion rate              | $\gamma_s$             | *                         | 1/d      |
